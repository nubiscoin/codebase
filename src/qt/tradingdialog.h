...
private slots:
    ...
    void on_BuyNUBIS_clicked();
    void on_SellNUBISBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputNUBIS_textChanged(const QString &arg1);
    ...
    QString BuyNUBIS(QString OrderType, double Quantity, double Rate);
    QString SellNUBIS(QString OrderType, double Quantity, double Rate);
